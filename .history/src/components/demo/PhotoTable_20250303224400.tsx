    ...
    { id: "title", label: "Title", sortable: true },
    {
      ...
      render: (photo: Photo) => (
        <div className="flex justify-center">
          <img
            // The url is not the actual URL, so i used picsum to get ima
    ...
    },
    {
      ...
      render: (photo: Photo) => (
        <div className="flex justify-center space-x-2">
          <a
            // The url is not the actual URL, so i used picsum to get image
            href={`https://picsum.photos/id/${photo.id}/200/300`}
            target="_blank"

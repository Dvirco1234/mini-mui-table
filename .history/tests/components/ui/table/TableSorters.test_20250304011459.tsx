...
describe("TableSorters", () => {
  ...
  it.skip("renders sortable columns with sort indicators", () => {
    render(
      <TableSorters
        columns={columns}
        sortColumn=""
  ...
  it.skip("shows active sort column with correct direction indicator", () => {
  ...
  it.skip("calls onSort with column key and direction when clicked", () => {
